<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="CMS.aspx.cs" EnableViewStateMac="false" Inherits="KitchenOnMyPlate.Masters.CMS" %>
 ...
 <script src="~/Scripts/jquery-1.4.1.min.js" type="text/javascript"></script>
    ...
    <link href="../Styles/modelstyle.css" rel="stylesheet" type="text/css" />
            ...
            <script type="text/javascript">
                ...
                function SendAdvEmailValidateLogin() 
                {
                    var txtuser = document.getElementById("txtEmailAdv").value;
                    if (txtuser == '') 
                    {
...
<%--     <div style="clear:both" ></div>     
     ...
     <div style=" width:112px;float:left;margin-top:9px"><a href="javascript:void(0)" onclick="ForgotPwd()" style=" margin-left:1px; color:#0099cc; font-family:Verdana;font-size:13px ; text-decoration:none;" title="" class="password">Forgot password</a></div>                  
        ...
        <div style="clear:both" ></div> 
              ...
              <input id="loginBttn" type="button" class="proceed" style="font-size:1em;"  onclick="return DoLogin();"  value="Login" />
 ...
 <div id="divLoggedLogin" runat="server" style="width:500px;height:350px; margin:0 auto;" visible="false" >
 ...
 <input id="Button3" type="button" onclick="window.location.href='HolidayMaster.aspx'" class="proceedBack" value="Holiday Master" />   
 <input id="Button6" type="button" onclick="window.location.href='../ManageOrders.aspx'" class="proceedBack" value="Manage Orders" />
 <input id="Button4" type="button" onclick="window.location.href='WeeklyMenu.aspx'" class="proceedBack" value="Weekly Menu" />   
 <input id="Button2" type="button" onclick="window.location.href='../ManageProducts.aspx'" class="proceedBack" value="Manage Product Category" />   
 <input id="Button5" type="button" onclick="window.location.href='../ManageSubProducts.aspx'" class="proceedBack" value="Manage Product" />   
 
 <div style="clear:both" ></div>

 <table style="margin-top:25px; border-top:1px solid #4b220c">
 <tr><td colspan="2"><span style="color:#4b220c; font-size:12px" >Enter Email Id to send link.<br /> Today only user will be able to place order which start from tomorrow</span></td></tr>
 <tr>
 <td>
   <input class="form-control"   title="Enter email Id" placeholder="Email Id" type="text"  runat="server" maxlength="60" name="txtEmailAdv" clientidmode="Static" id="txtEmailAdv" />
   </td>
   <td>
 <asp:Button ID="btnAdvance" runat="server" class="proceedBack" 
         OnClientClick="return SendAdvEmailValidateLogin();"  Text="ORDER ADVANCE" 
         onclick="btnAdvance_Click" style="padding:0.6em 1.3em; margin-top:-0.3em" />
     </td>
         </tr>
    </table>
