<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PaymentProcess.aspx.cs" Inherits="KitchenOnMyPlate.PaymentProcess" %>
...
//            billing_zip = Trim(document.getElementById("billing_zip").value);
            ...
            //alert('a');            
            //alert($("#chkSamAsShipping").is(':checked'));
...
//              }, 1000);
      ...
      function SetBilling() {
          ...
          document.getElementById("billing_address").value = Trim($("#txtFlatB").val()) + ", " + Trim($("#txtBuildingB").val()) + ", " + Trim($("#txtStreetB").val() +", "+ $("#txtLocation option:selected").html());
...
<article class="page-art">
        ...
        <div style="width:96%;" >
           ...
           <div class="contact-form_grid" style="float:left; text-align:left; width:50%;height:auto;padding-right:20px;">
            ...
            <input id="txtStreet" name="txtStreet" runat="server" placeholder="Street, Location" title="Street and Location" clientidmode="Static" maxlength="100"  class="textbox" type="text" value="" style="width:100%;float:left"/>
          ...
          <div class="contact-form_grid" style="float:left; text-align:left; width:50%;height:auto; padding-left:20px;">
			...
			<input id="txtLandMark" runat="server" clientidmode="Static"  class="textbox AlphaClass" maxlength="50" type="text" value=""/>
        ...
        <strong>YOUR BILLING ADDRESS IS :&nbsp;&nbsp;&nbsp; <input type="radio"  id="chkSamAsShipping" runat="server" clientidmode="Static" checked="true" onclick="CopyShippingToBilling();" name="bll" /><label for="chkSamAsShipping"></label>&nbsp;&nbsp;SAME AS ABOVE &nbsp;&nbsp;&nbsp<input id="Radio1" type="radio" onclick="CopyShippingToBilling();" name="bll" /> <label for="Radio1"></label>&nbsp;&nbsp;DIFFERENT BILLING ADDRESS<asp:Label ID="Label1" runat="server" ></asp:Label></strong><br/>	
    </div>
...
<!--Shikha work end -->
    ...
    <script type="text/javascript">
        ...
        function SaveShipping() {
            ...
            //Create address              
            document.getElementById("delivery_address").value = Trim($("#txtFlat").val()) +", "+ Trim($("#txtBuilding").val()) +", "+ Trim($("#txtStreet").val()+", "+$("#txtLocation option:selected").html());
