...
<article class="page-art">
        ...
        <div style="width:100%;" >
                ...
                <%--<tr class="divRow"><td style="width:10%;"></td><td style="width:60%;" id="divPNAME"></td><td style="width:30%;"><span id='spCharge' class='price'></span></td></tr>--%>                                        
                    <tr id="trdiscount"  class="divRow"><td colspan="4" style="width:70%;" align="right"><span class='priceTotaltxt'>AMOUNT (AFTER <span id="spnDiscountCount" ></span> % DISCOUNT)<span class='sppp'>&nbsp;&nbsp;&nbsp;</span></span></td><td style="width:30%;" align="right" ><span id='spnDiscount' class='priceTotal'></span></td></tr>
