...
var _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation = require('../dev/modules/handle-dom');

/*
 * Handy utilities
 */

var _extend$hexToRgb$isIE8$logStr$colorLuminance = require('../dev/modules/utils');

/*
 *  Handle sweetAlert's DOM elements
 */

var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = require('../dev/modules/handle-swal-dom');

// Handle button events and keyboard events

var _handleButton$handleConfirm$handleCancel = require('../dev/modules/handle-click');

var _handleKeyDown = require('../dev/modules/handle-key');

var _handleKeyDown2 = _interopRequireWildcard(_handleKeyDown);

// Default values

var _defaultParams = require('../dev/modules/default-params');

var _defaultParams2 = _interopRequireWildcard(_defaultParams);

var _setParameters = require('../dev/modules/set-params');
...
},{"../dev/modules/default-params":2,"../dev/modules/handle-click":3,"../dev/modules/handle-dom":4,"../dev/modules/handle-key":5,"../dev/modules/handle-swal-dom":6,"../dev/modules/set-params":8,"../dev/modules/utils":9}],2:[function(require,module,exports){
'use strict';
