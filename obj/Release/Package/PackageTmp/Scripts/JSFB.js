...
//            });
        ...
        function CreateSessionFB(uid,emailid,fname,lname) {

            if (emailid != '') {

                $.ajax({
                    type: "POST",
                    url: "KompServices.asmx/CreateSessionFB",
                    contentType: "application/json; charset=utf-8",
                    data: "{userid:'" + uid + "',emailId:'" + emailid + "', firstName:'" + fname + "', lastName:'" + lname + "'}",
                    dataType: "json",
                    success: function (result) {
                                            
                        //$('#ctl00_loggendUser').text("Welcome " + fname + " !!");
                        ...
                        //Below two for usercontrol post property requirement
