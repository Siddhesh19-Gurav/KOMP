<%@ Page Title="Daily Meal Plan - Customised" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DailyPackagingName.aspx.cs"   Inherits="MumbaiPropertyMart.DailyPackagingName" %>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
<head id="Head1" runat="server">
    <title>Daily Meal Plan - Customised</title>  
...
<span style="margin-top:60px;font-size:2em;">KITCHEN ON MY PLATE REPORTS</span>
    ...
    <td>    
    Lunch/Dinner</td>
    <td colspan="2"><div class="dropdown" style="float:left; margin-left:10px" >
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet"  style="width:50%" >  <asp:Label ID="lblName" runat="server" Text="Report : Daily Packaging Name"></asp:Label>  </div> 
