<%@ Page Title="Users" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ReportLocationView.aspx.cs"   Inherits="MumbaiPropertyMart.ReportLocationView" %>
...
<span style="margin-top:60px;font-size:2em;">KITCHEN ON MY PLATE REPORTS</span>
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet">  <asp:Label ID="lblName" runat="server" Text="Report : Tomorrow's Delivery View"></asp:Label>  </div> 
