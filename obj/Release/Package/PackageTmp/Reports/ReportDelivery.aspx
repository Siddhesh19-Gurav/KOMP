<%@ Page Title="Users" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ReportDelivery.aspx.cs"   Inherits="MumbaiPropertyMart.ReportDelivery" %>
...
<span style="margin-top:60px;font-size:2em;">KITCHEN ON MY PLATE REPORTS</span>
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet">  <asp:Label ID="lblName" runat="server" Text="Report : Orders"></asp:Label>  </div> 
        <div class="RightSet">  Total Count :<asp:Label ID="lblTotal" runat="server" Text=""></asp:Label>  </div> 
    </div>

    <asp:GridView ID="gvPrice" runat="server" CssClass="CommonFont" PageSize="50"  Width="100%"    PagerSettings-Mode="Numeric" AllowPaging="True"
