<%@ Page Title="Daily Meal Plan - Customised" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DailyMealPlan.aspx.cs"   Inherits="MumbaiPropertyMart.DailyMealPlan" %>
...
<span style="margin-top:60px;font-size:2em;">KITCHEN ON MY PLATE REPORTS</span>
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet"  style="width:50%" >  <asp:Label ID="lblName" runat="server" Text="Report : Daily Meal Plan - Customised"></asp:Label>  </div> 
