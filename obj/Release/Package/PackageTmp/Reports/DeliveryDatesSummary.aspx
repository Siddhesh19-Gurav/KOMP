<%@ Page Title="Delivery Dates Summary" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DeliveryDatesSummary.aspx.cs"   Inherits="MumbaiPropertyMart.DeliveryDatesSummary" %>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
<head id="Head1" runat="server">
    <title>Delivery Dates Summary</title>  
...
//        }
    ...
    function Validate() {
        ...
        if ($("#txtPossessionDateTo").val() == "") {
            alert('Please Enter to Date');
            $("#txtPossessionDateTo").focus();
            return false;
        }
...
<div class="dropdown" style="float:left; margin-left:10px" >
    ...
    <input id="txtPossessionDate" style="float:left; width:150px" runat="server" clientidmode="Static" placeholder="Order From" type="text" />
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet"  style="width:50%" >  <asp:Label ID="lblName" runat="server" Text="Report : Delivery Dates Summary"></asp:Label>  </div> 
