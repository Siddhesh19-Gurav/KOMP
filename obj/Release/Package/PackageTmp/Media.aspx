<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Media.aspx.cs" Inherits="KitchenOnMyPlate.Media" %>
...
<!---/End-Animation---->
	    ...
	    <div class="callbacks_container">
	      <ul class="rslides" id="slider">
	        <li>
	          <img src="images/banner/Media.jpg" alt="KOMP Media">
      ...
      <div class="row faq">
        <div style="clear:both" ></div>
         <article class="page-art">
                        <h1 class="page-titleMain">MEDIA</h1>
                        </article>
                  <div class="col-ms-12">
...
<!--Contact Start-->
			     ...
			     <div class="contact-form_grid" style="float:left; text-align:left">
                    ...
                    <div class="divider" style="margin-top:0px; margin-bottom:1px; "></div>
                      		...
                      		<div style="clear:both" ></div>
                            <h1 style="margin-top:-45px" >Coming Soon..</h1>
