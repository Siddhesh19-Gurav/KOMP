<%@ Page Title="Users" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ReportMealDetails.aspx.cs"   Inherits="MumbaiPropertyMart.ReportMealDetails" %>
...
<span style="margin-top:60px;font-size:2em;">KITCHEN ON MY PLATE REPORTS</span>
    ...
    <div style="float:left; width:100px;text-align:right;margin-top:2px; " >Type Of Meal</div>
    <div class="dropdown" style="float:left; margin-left:10px" >
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet">  <asp:Label ID="lblName" runat="server" Text="Report : Ordered Meal Details"></asp:Label>  </div> 
