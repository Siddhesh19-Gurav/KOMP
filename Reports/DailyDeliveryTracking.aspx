<%@ Page Title="Daily Meal Plan - Customised" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DailyDeliveryTracking.aspx.cs"   Inherits="MumbaiPropertyMart.DailyDeliveryTracking" %>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
<head id="Head1" runat="server">
    <title>Daily Delivery Tracking - Report</title>  
...
<span style="margin-top:60px;font-size:2em;">KITCHEN ON MY PLATE REPORTS</span>
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet"  style="width:50%" >  <asp:Label ID="lblName" runat="server" Text="Report : Daily Delivery Tracking"></asp:Label>  </div> 
