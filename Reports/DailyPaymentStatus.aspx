<%@ Page Title="Users" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DailyPaymentStatus.aspx.cs"   Inherits="MumbaiPropertyMart.DailyPaymentStatus" %>
...
<%--    <div style="float:left; width:100px;text-align:right;margin-top:2px; " >Order</div>
    ...
    <div style="float:left; width:200;text-align:right;margin-top:2px;margin-left:10px; " >Payment Status</div>
    <div class="dropdown" style="float:left; margin-left:10px" >
    ...
    <div style=" width:200px; float:left; margin-left:10px" > 
        ...
        <asp:ImageButton ID="ImageButton1" runat="server"  Width="30px" Height="30px"
                ImageUrl="~/images/excel_icon.png" onclick="ImageButton1_Click" ></asp:ImageButton> <br />Export
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet">  <asp:Label ID="lblName" runat="server" Text="Report : Payment Status"></asp:Label>  </div> 
        <div class="RightSet">  Total Count :<asp:Label ID="lblTotal" runat="server" Text=""></asp:Label>  </div> 
    </div>

    <asp:GridView ID="gvPrice" runat="server" CssClass="CommonFont" PageSize="50"   PagerSettings-Mode="Numeric" AllowPaging="True"  Width="100%"  
