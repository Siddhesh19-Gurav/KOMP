    ...
    public partial class ReportDelivery : System.Web.UI.Page
    {
        ...
        protected void BindReport(bool IsLast)
        {
            try
            {
                ...
                strQuery = strQuery + " OrderId as 'Order Id', ShippingBilling.FirstName as 'Customer Name',replace(ShippingBilling.Address,'$',', ')+','+ShippingBilling.LandMark+' '+ShippingBilling.pincode as 'Address',ShippingBilling.Mobile as 'Mobile', " +
