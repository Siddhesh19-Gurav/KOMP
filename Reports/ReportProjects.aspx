<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportProjects.aspx.cs" Inherits="MumbaiPropertyMart.ReportProjects" %>
...
<div style="float:left; width:100px;text-align:right;margin-top:2px; " >Property Type</div>
    ...
    <div class="DescHeader HeaderBG14FontTopRound"  > 
        <div class="LeftSet">  <asp:Label ID="lblName" runat="server" Text="Report : Project List"></asp:Label>  </div> 
